...
def test_protobuf_model_import__neptune_api_and_neptune():
    ...
    import neptune_query.generated.neptune_api.proto.neptune_pb

    for loader, module_name, is_pkg in pkgutil.walk_packages(
        neptune_query.generated.neptune_api.proto.neptune_pb.__path__,
        neptune_query.generated.neptune_api.proto.neptune_pb.__name__ + ".",
    ):
...
def test_serialize_sample_model__neptune_ingest():
    pytest.importorskip("neptune_query.generated.neptune_api.proto.neptune_pb")
    from neptune_query.generated.neptune_api.proto.neptune_pb.ingest.v1.common_pb2 import ForkPoint
