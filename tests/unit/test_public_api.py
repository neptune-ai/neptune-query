...
@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_list_experiments_metadata(mock_use_thread_local: MagicMock) -> None:
    list_experiments()
    _assert_metadata_set(mock_use_thread_local, "list_experiments")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_list_attributes_metadata(mock_use_thread_local: MagicMock) -> None:
    list_attributes()
    _assert_metadata_set(mock_use_thread_local, "list_attributes")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_metrics_metadata(mock_use_thread_local: MagicMock) -> None:
    fetch_metrics(experiments="exp", attributes="attr")
    _assert_metadata_set(mock_use_thread_local, "fetch_metrics")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_experiments_table_metadata(mock_use_thread_local: MagicMock) -> None:
    fetch_experiments_table()
    _assert_metadata_set(mock_use_thread_local, "fetch_experiments_table")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_series_metadata(mock_use_thread_local: MagicMock) -> None:
    fetch_series(experiments="exp", attributes="attr")
    _assert_metadata_set(mock_use_thread_local, "fetch_series")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_list_runs_metadata(mock_use_thread_local: MagicMock) -> None:
    runs.list_runs()
    _assert_metadata_set(mock_use_thread_local, "runs.list_runs")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_list_runs_attributes_metadata(mock_use_thread_local: MagicMock) -> None:
    runs.list_attributes()
    _assert_metadata_set(mock_use_thread_local, "runs.list_attributes")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_runs_metrics_metadata(mock_use_thread_local: MagicMock) -> None:
    runs.fetch_metrics(runs="run", attributes="attr")
    _assert_metadata_set(mock_use_thread_local, "runs.fetch_metrics")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_runs_table_metadata(mock_use_thread_local: MagicMock) -> None:
    runs.fetch_runs_table()
    _assert_metadata_set(mock_use_thread_local, "runs.fetch_runs_table")


@patch("neptune_query.internal.query_metadata_context.concurrency.use_thread_local")
def test_fetch_runs_series_metadata(mock_use_thread_local: MagicMock) -> None:
    runs.fetch_series(runs="run", attributes="attr")
    _assert_metadata_set(mock_use_thread_local, "runs.fetch_series")
...
def _assert_metadata_set(mock_use_thread_local: MagicMock, expected_func_name: str) -> None:
    ...
    assert query_metadata.api_function == expected_func_name
