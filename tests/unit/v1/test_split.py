...
@pytest.mark.parametrize(
    ...
    [
        ...
        (100, 1, 100, 0, []),
        (100, 1, 100, 1, [1]),
        (1000, 1, 100, 400, [55] * 7 + [15]),
        (1000, 1, 1000, 400, [55] * 7 + [15]),
        (1000, 1, 10000, 400, [22] * 18 + [4]),
        (1000, 1, 1000000, 20, [1] * 20),
        (100, 400, 1000, 1, [55] * 7 + [15]),
        (1000, 400, 1000, 1, [55] * 7 + [15]),
        (10000, 400, 1000, 1, [55] * 7 + [15]),
        (10, 40000, 10, 1, ([252] * 15 + [220]) * 10),
        (1000, 10, 1000, 40, [55] * 7 + [15]),
        (1000, 20, 1000, 40, [87] * 9 + [17]),
    ],
)
