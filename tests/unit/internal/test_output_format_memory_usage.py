...
def test_create_metrics_dataframe_timing():
    ...
    duration = datetime.timedelta(microseconds=(end - start) / 1000)

    print()
    print(f"Dataframe creation took {precisedelta(duration, minimum_unit='microseconds')}")
