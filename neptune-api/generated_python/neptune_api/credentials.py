...
class Credentials:
    ...
    def from_api_key(cls, api_key: str) -> "Credentials":
        ...
        token_origin_address, api_url = (
            token_data.get("api_address"),
        ...
        return Credentials(
            api_key=api_key, base_url=str(api_url) or str(token_origin_address)
        )
...
def deserialize(api_key: str) -> Dict[str, Any]:
    try:
        data: Dict[str, Any] = json.loads(
            base64.b64decode(api_key.encode()).decode("utf-8")
        )
        return data
