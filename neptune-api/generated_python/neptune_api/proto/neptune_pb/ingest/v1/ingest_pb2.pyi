...
class _IngestCodeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_IngestCode.ValueType],
    builtins.type,
):
...
class BatchContext(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, project: builtins.str = ..., api_key: builtins.bytes = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["api_key", b"api_key", "project", b"project"]
    ) -> None: ...
...
class UpdateRun(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        update_snapshots: neptune_pb.ingest.v1.common_pb2.UpdateRunSnapshots
        | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "mode", b"mode", "update_snapshots", b"update_snapshots"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing.Literal["update_snapshots"] | None: ...
...
class BatchProjectOperations(google.protobuf.message.Message):
    ...
    class UpdateRunsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, key: builtins.str = ..., value: global___UpdateRun | None = ...
        ) -> None: ...
        def HasField(
    ...
    def create_runs(
        ...
        neptune_pb.ingest.v1.common_pb2.Run
    ]:
    ...
    def update_runs(
        ...
        builtins.str, global___UpdateRun
    ]:
    ...
    def __init__(
        ...
        *,
        ...
        create_missing_project: builtins.bool = ...,
        create_runs: collections.abc.Iterable[neptune_pb.ingest.v1.common_pb2.Run]
        | None = ...,
        update_runs: collections.abc.Mapping[builtins.str, global___UpdateRun]
        | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["context", b"context"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class CreateRunResult(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        run: neptune_pb.ingest.v1.common_pb2.Run | None = ...,
        error: global___CreateRunError | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal["error", b"error", "run", b"run", "type", b"type"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal["error", b"error", "run", b"run", "type", b"type"],
...
class ResultSummary(google.protobuf.message.Message):
    ...
    class FailedByGRPCCodeCounters(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing.Literal["count", b"count", "grpc_code", b"grpc_code"],
        ) -> None: ...
    ...
    class IngestCodeCounters(google.protobuf.message.Message):
        ...
        def ClearField(
            self,
            field_name: typing.Literal[
                "count", b"count", "ingest_code", b"ingest_code"
            ],
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        successful_count: builtins.int = ...,
        failed_count: builtins.int = ...,
        failed_by_grpc_code: collections.abc.Iterable[
            global___ResultSummary.FailedByGRPCCodeCounters
        ]
        | None = ...,
        failed_by_ingest_code: collections.abc.Iterable[
            global___ResultSummary.IngestCodeCounters
        ]
        | None = ...,
    ) -> None: ...
...
class UpdateRunResults(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["operations_summary", b"operations_summary"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class BatchResult(google.protobuf.message.Message):
    ...
    class UpdateRunResultsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            key: builtins.str = ...,
            value: global___UpdateRunResults | None = ...,
        ) -> None: ...
        def HasField(
            self, field_name: typing.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def update_run_results(
        ...
        builtins.str, global___UpdateRunResults
    ]:
        """Run update results."""
    ...
    def __init__(
        ...
        *,
        ...
        operations_summary: global___ResultSummary | None = ...,
        project: builtins.str = ...,
        create_run_results: collections.abc.Iterable[global___CreateRunResult]
        | None = ...,
        update_run_results: collections.abc.Mapping[
            builtins.str, global___UpdateRunResults
        ]
        | None = ...,
        message: builtins.str = ...,
...
class IngestRequest(google.protobuf.message.Message):
    ...
    def batches(
        ...
        global___BatchProjectOperations
    ]:
    ...
    def __init__(
        self,
        *,
        batches: collections.abc.Iterable[global___BatchProjectOperations] | None = ...,
    ) -> None: ...
