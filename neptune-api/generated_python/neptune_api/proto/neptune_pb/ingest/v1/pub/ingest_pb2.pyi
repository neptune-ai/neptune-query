...
class RunOperation(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        project: builtins.str = ...,
        run_id: builtins.str = ...,
        create_missing_project: builtins.bool | None = ...,
        create: neptune_pb.ingest.v1.common_pb2.Run | None = ...,
        update: neptune_pb.ingest.v1.common_pb2.UpdateRunSnapshot | None = ...,
        update_batch: neptune_pb.ingest.v1.common_pb2.UpdateRunSnapshots | None = ...,
        api_key: builtins.bytes | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_api_key",
            b"_api_key",
            "_create_missing_project",
            b"_create_missing_project",
            "api_key",
            b"api_key",
            "create",
            b"create",
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_api_key", b"_api_key"]
    ) -> typing.Literal["api_key"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_create_missing_project", b"_create_missing_project"
        ],
    ) -> typing.Literal["create_missing_project"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["operation", b"operation"]
    ) -> typing.Literal["create", "update", "update_batch"] | None: ...
