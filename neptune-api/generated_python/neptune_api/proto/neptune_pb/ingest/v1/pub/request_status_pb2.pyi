...
class RequestStatus(google.protobuf.message.Message):
    ...
    class CodeByCount(google.protobuf.message.Message):
        ...
        def ClearField(
            ...
            field_name: typing.Literal[
                "code", b"code", "count", b"count", "detail", b"detail"
            ],
        ) -> None: ...
    ...
    def code_by_count(
        ...
        global___RequestStatus.CodeByCount
    ]: ...
    def __init__(
        self,
        *,
        code_by_count: collections.abc.Iterable[global___RequestStatus.CodeByCount]
        | None = ...,
    ...
    def WhichOneof(
        self,
        oneof_group: typing.Literal["_shared_error_message", b"_shared_error_message"],
