...
class _SET_OPERATIONEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[
        _SET_OPERATION.ValueType
    ],
    builtins.type,
):
...
class Step(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, whole: builtins.int = ..., micro: builtins.int = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["micro", b"micro", "whole", b"whole"]
    ) -> None: ...
...
class ForkPoint(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        requested_parent_id: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_parent_project",
            b"_parent_project",
            "_requested_parent_id",
            b"_requested_parent_id",
            "parent_project",
            b"parent_project",
            "requested_parent_id",
            b"requested_parent_id",
            "step",
            b"step",
        ],
    ) -> builtins.bool: ...
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_parent_project", b"_parent_project"]
    ) -> typing.Literal["parent_project"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal["_requested_parent_id", b"_requested_parent_id"],
    ) -> typing.Literal["requested_parent_id"] | None: ...
...
class StringSet(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, values: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
...
class FileRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "mime_type", b"mime_type", "path", b"path", "size_bytes", b"size_bytes"
        ],
    ) -> None: ...
...
class Histogram(google.protobuf.message.Message):
    ...
    class Counts(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, values: collections.abc.Iterable[builtins.int] | None = ...
        ) -> None: ...
        def ClearField(
    ...
    class Densities(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, values: collections.abc.Iterable[builtins.float] | None = ...
        ) -> None: ...
        def ClearField(
            self, field_name: typing.Literal["values", b"values"]
        ) -> None: ...
    ...
    def __init__(
        self,
        *,
        bin_edges: collections.abc.Iterable[builtins.float] | None = ...,
        counts: global___Histogram.Counts | None = ...,
        densities: global___Histogram.Densities | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "counts", b"counts", "densities", b"densities", "values", b"values"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["values", b"values"]
    ) -> typing.Literal["counts", "densities"] | None: ...
...
class Value(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        file_ref: global___FileRef | None = ...,
...
class ModifyStringSet(google.protobuf.message.Message):
    ...
    def values(
        ...
        builtins.str, global___SET_OPERATION.ValueType
    ]: ...
    def __init__(
        self,
        *,
        values: collections.abc.Mapping[builtins.str, global___SET_OPERATION.ValueType]
        | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["values", b"values"]) -> None: ...
...
class ModifySet(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["string", b"string", "type", b"type"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["string", b"string", "type", b"type"]
    ) -> None: ...
...
class Owner(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, user_id: builtins.str = ..., service_account_id: builtins.str = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["owner_type", b"owner_type"]
    ) -> typing.Literal["user_id", "service_account_id"] | None: ...
...
class OffsetMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        broker_version: builtins.int | None = ...,
        message_offset: builtins.int | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_broker_version", b"_broker_version"]
    ) -> typing.Literal["broker_version"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_message_offset", b"_message_offset"]
    ) -> typing.Literal["message_offset"] | None: ...
...
class Run(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        tracker: builtins.str | None = ...,
        inherit_configs: builtins.bool | None = ...,
        start_processing_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        offset_metadata: global___OffsetMetadata | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            ...
            "_run_id",
            b"_run_id",
            "_start_processing_time",
            b"_start_processing_time",
            "_tracker",
            b"_tracker",
            "creation_time",
            b"creation_time",
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_creation_time", b"_creation_time"]
    ) -> typing.Literal["creation_time"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_experiment_id", b"_experiment_id"]
    ) -> typing.Literal["experiment_id"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_family", b"_family"]
    ) -> typing.Literal["family"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_fork_point", b"_fork_point"]
    ) -> typing.Literal["fork_point"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_inherit_configs", b"_inherit_configs"]
    ) -> typing.Literal["inherit_configs"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_offset_metadata", b"_offset_metadata"]
    ) -> typing.Literal["offset_metadata"] | None: ...
    @typing.overload
    def WhichOneof(
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_request_id", b"_request_id"]
    ) -> typing.Literal["request_id"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_run_id", b"_run_id"]
    ) -> typing.Literal["run_id"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
            "_start_processing_time", b"_start_processing_time"
        ],
    ) -> typing.Literal["start_processing_time"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_tracker", b"_tracker"]
    ) -> typing.Literal["tracker"] | None: ...
...
class Preview(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, is_preview: builtins.bool = ..., completion_ratio: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "completion_ratio", b"completion_ratio", "is_preview", b"is_preview"
        ],
    ) -> None: ...
...
class UpdateRunSnapshot(google.protobuf.message.Message):
    ...
    class AssignEntry(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, key: builtins.str = ..., value: global___Value | None = ...
        ) -> None: ...
        def HasField(
    ...
    class ModifySetsEntry(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, key: builtins.str = ..., value: global___ModifySet | None = ...
        ) -> None: ...
        def HasField(
            self, field_name: typing.Literal["value", b"value"]
        ) -> builtins.bool: ...
    ...
    def assign(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Value]:
    ...
    def modify_sets(
        ...
        builtins.str, global___ModifySet
    ]:
    ...
    def __init__(
        ...
        *,
        step: global___Step | None = ...,
        timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        preview: global___Preview | None = ...,
        assign: collections.abc.Mapping[builtins.str, global___Value] | None = ...,
        modify_sets: collections.abc.Mapping[builtins.str, global___ModifySet]
        | None = ...,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_preview", b"_preview"]
    ) -> typing.Literal["preview"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_request_id", b"_request_id"]
    ) -> typing.Literal["request_id"] | None: ...
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_step", b"_step"]
    ) -> typing.Literal["step"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_timestamp", b"_timestamp"]
    ) -> typing.Literal["timestamp"] | None: ...
...
class UpdateRunSnapshots(google.protobuf.message.Message):
    ...
    def snapshots(
        ...
        global___UpdateRunSnapshot
    ]: ...
    def __init__(
        self,
        *,
        snapshots: collections.abc.Iterable[global___UpdateRunSnapshot] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["snapshots", b"snapshots"]
    ) -> None: ...
