...
class ProtoAttributesSearchResultDTO(google.protobuf.message.Message):
    ...
    def entries(
        ...
        global___ProtoAttributeDefinitionDTO
    ]: ...
    def __init__(
        self,
        *,
        entries: collections.abc.Iterable[global___ProtoAttributeDefinitionDTO]
        | None = ...,
    ) -> None: ...
...
class ProtoAttributeDefinitionDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, name: builtins.str = ..., type: builtins.str = ...
    ) -> None: ...
    def ClearField(
...
class ProtoQueryAttributesResultDTO(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["nextPage", b"nextPage"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["entries", b"entries", "nextPage", b"nextPage"]
    ) -> None: ...
...
class ProtoQueryAttributesExperimentResultDTO(google.protobuf.message.Message):
    ...
    def attributes(
        ...
        neptune_pb.api.v1.model.leaderboard_entries_pb2.ProtoAttributeDTO
    ]: ...
    def __init__(
        self,
        *,
