...
class ProtoSeriesValuesResponseDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        series: collections.abc.Iterable[
            global___ProtoSeriesValuesSingleSeriesResponseDTO
        ]
        | None = ...,
    ) -> None: ...
...
global___ProtoSeriesValuesSingleSeriesResponseDTO = (
    ProtoSeriesValuesSingleSeriesResponseDTO
)
...
class ProtoSeriesValuesSearchAfterDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, finished: builtins.bool = ..., token: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["finished", b"finished", "token", b"token"]
    ) -> None: ...
...
class ProtoFloatSeriesValuesSingleSeriesResponseDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        requestId: builtins.str = ...,
        series: global___ProtoFloatSeriesValuesDTO | None = ...,
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["series", b"series"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["requestId", b"requestId", "series", b"series"]
    ) -> None: ...
...
class ProtoFloatSeriesValuesDTO(google.protobuf.message.Message):
    ...
    def values(
        ...
        global___ProtoFloatPointValueDTO
    ]: ...
    def __init__(
        self,
        *,
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "total_item_count", b"total_item_count", "values", b"values"
        ],
    ) -> None: ...
...
class ProtoSeriesValuesDTO(google.protobuf.message.Message):
    ...
    def values(
        ...
        global___ProtoPointValueDTO
    ]: ...
    def __init__(
        self,
        *,
        values: collections.abc.Iterable[global___ProtoPointValueDTO] | None = ...,
    ) -> None: ...
...
class ProtoPointValueDTO(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_object", b"_object"]
    ) -> typing.Literal["object"] | None: ...
    @typing.overload
    def WhichOneof(
...
class ProtoHistogram(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "edges", b"edges", "type", b"type", "values", b"values"
        ],
    ) -> None: ...
...
class ProtoFileRef(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "mimeType", b"mimeType", "path", b"path", "sizeBytes", b"sizeBytes"
        ],
    ) -> None: ...
...
class ProtoTimeseriesBucketsDTO(google.protobuf.message.Message):
    ...
    def entries(
        ...
        global___TimeseriesBuckets
    ]: ...
    def __init__(
        self,
        *,
        entries: collections.abc.Iterable[global___TimeseriesBuckets] | None = ...,
    ) -> None: ...
...
class TimeseriesBuckets(google.protobuf.message.Message):
    ...
    def bucket(
        ...
        global___TimeseriesBucket
    ]: ...
    def __init__(
        self,
        *,
        requestId: builtins.str = ...,
        bucket: collections.abc.Iterable[global___TimeseriesBucket] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["bucket", b"bucket", "requestId", b"requestId"]
    ) -> None: ...
...
class TimeseriesBucket(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_first", b"_first"]
    ) -> typing.Literal["first"] | None: ...
    @typing.overload
    def WhichOneof(
