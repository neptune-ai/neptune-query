    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_attribute_filter, Unset):
            ...
            for attribute_filter_item_data in _attribute_filter:
                attribute_filter_item = AttributeFilterDTO.from_dict(
                    attribute_filter_item_data
                )
        ...
        if isinstance(_attribute_name_filter, Unset):
            ...
            attribute_name_filter = AttributeNameFilterDTO.from_dict(
                _attribute_name_filter
            )
