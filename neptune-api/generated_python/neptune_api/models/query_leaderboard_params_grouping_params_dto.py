...
if TYPE_CHECKING:
    ...
    from ..models.query_leaderboard_params_field_dto import (
...
class QueryLeaderboardParamsGroupingParamsDTO:
    ...
    opened_groups_with_pagination: Union[
        Unset, List["QueryLeaderboardParamsOpenedGroupWithPaginationParamsDTO"]
    ] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.opened_groups_with_pagination, Unset):
            ...
            ) in self.opened_groups_with_pagination:
                opened_groups_with_pagination_item = (
                    opened_groups_with_pagination_item_data.to_dict()
                )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_opened_groups_with_pagination, Unset):
            ...
            for (
                opened_groups_with_pagination_item_data
            ) in _opened_groups_with_pagination:
                opened_groups_with_pagination_item = (
                    QueryLeaderboardParamsOpenedGroupWithPaginationParamsDTO.from_dict(
                        opened_groups_with_pagination_item_data
                    )
                )
