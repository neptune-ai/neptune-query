...
if TYPE_CHECKING:
    ...
    from ..models.query_leaderboard_params_sorting_params_dto import (
        QueryLeaderboardParamsSortingParamsDTO,
    )
    from ..models.query_leaderboard_params_pagination_dto import (
        QueryLeaderboardParamsPaginationDTO,
    )
    from ..models.query_leaderboard_params_grouping_params_dto import (
        QueryLeaderboardParamsGroupingParamsDTO,
    )
    from ..models.query_leaderboard_params_attribute_filter_dto import (
        QueryLeaderboardParamsAttributeFilterDTO,
    )
    from ..models.query_leaderboard_params_query_aliases_dto import (
...
class SearchLeaderboardEntriesParamsDTO:
    ...
    attribute_filters: Union[
        Unset, List["QueryLeaderboardParamsAttributeFilterDTO"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_attribute_filters, Unset):
            ...
            for attribute_filters_item_data in _attribute_filters:
                attribute_filters_item = (
                    QueryLeaderboardParamsAttributeFilterDTO.from_dict(
                        attribute_filters_item_data
                    )
                )
        ...
        if isinstance(_query_name_aliases, Unset):
            ...
            query_name_aliases = QueryLeaderboardParamsQueryAliasesDTO.from_dict(
                _query_name_aliases
            )
