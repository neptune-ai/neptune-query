...
class NeptuneAuthenticator(httpx.Auth):
    ...
    def __init__(
        ...
        self._api_key_exchange_factory: Callable[[Client, Credentials], OAuthToken] = (
            api_key_exchange_factory
        )
    ...
    def _refresh_token(self) -> None:
        with self.__LOCK:
            ...
            if self._token is None:
                self._token = self._api_key_exchange_factory(
                    self._client, self._credentials
                )
