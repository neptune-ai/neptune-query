...
class BulkRequestStatus(google.protobuf.message.Message):
    ...
    def statuses(
        ...
        neptune_pb.ingest.v1.pub.request_status_pb2.RequestStatus
    ]: ...
    def __init__(
        self,
        *,
        statuses: collections.abc.Iterable[neptune_pb.ingest.v1.pub.request_status_pb2.RequestStatus] | None = ...,
    ) -> None: ...
...
class SubmitResponse(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, request_id: builtins.str = ..., request_ids: collections.abc.Iterable[builtins.str] | None = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["request_id", b"request_id", "request_ids", b"request_ids"]
    ) -> None: ...
...
class BulkStatusCheck(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, project: builtins.str = ..., ids: collections.abc.Iterable[global___RequestId] | None = ...
    ) -> None: ...
...
class BulkCheckDetail(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        project: builtins.str = ...,
        ids: collections.abc.Iterable[global___RequestId] | None = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_limit", b"_limit", "_next_cursor", b"_next_cursor", "limit", b"limit", "next_cursor", b"next_cursor"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_next_cursor", b"_next_cursor"]
    ) -> typing.Literal["next_cursor"] | None: ...
...
class IngestResultDetail(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        request_id: global___RequestId | None = ...,
        path: builtins.str = ...,
        ingest_code: neptune_pb.ingest.v1.ingest_pb2.IngestCode.ValueType = ...,
        error_detail: builtins.str = ...,
    ) -> None: ...
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "error_detail", b"error_detail", "ingest_code", b"ingest_code", "path", b"path", "request_id", b"request_id"
        ],
    ) -> None: ...
...
class BulkIngestResultDetail(google.protobuf.message.Message):
    ...
    def details(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___IngestResultDetail]: ...
    def __init__(
        self,
        *,
        details: collections.abc.Iterable[global___IngestResultDetail] | None = ...,
        next_cursor: builtins.str = ...,
    ) -> None: ...
