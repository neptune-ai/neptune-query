...
class _SET_OPERATIONEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SET_OPERATION.ValueType], builtins.type
):
...
class ForkPoint(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_requested_parent_id", b"_requested_parent_id"]
...
class FileRef(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, path: builtins.str = ..., size_bytes: builtins.int = ..., mime_type: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["mime_type", b"mime_type", "path", b"path", "size_bytes", b"size_bytes"]
    ) -> None: ...
...
class Histogram(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["counts", b"counts", "densities", b"densities", "values", b"values"]
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "bin_edges", b"bin_edges", "counts", b"counts", "densities", b"densities", "values", b"values"
        ],
    ) -> None: ...
    def WhichOneof(
...
class Value(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        "float64", "int64", "bool", "string", "timestamp", "string_set", "file_ref", "histogram"
    ] | None: ...
...
class ModifyStringSet(google.protobuf.message.Message):
    ...
    def values(
        self,
    ) -> google.protobuf.internal.containers.ScalarMap[builtins.str, global___SET_OPERATION.ValueType]: ...
    def __init__(
        self, *, values: collections.abc.Mapping[builtins.str, global___SET_OPERATION.ValueType] | None = ...
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["values", b"values"]) -> None: ...
...
class Owner(google.protobuf.message.Message):
    ...
    def HasField(
        self,
        field_name: typing.Literal[
            "owner_type", b"owner_type", "service_account_id", b"service_account_id", "user_id", b"user_id"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class OffsetMetadata(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, broker_version: builtins.int | None = ..., message_offset: builtins.int | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
...
class Run(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_start_processing_time", b"_start_processing_time"]
...
class Preview(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["completion_ratio", b"completion_ratio", "is_preview", b"is_preview"]
    ) -> None: ...
...
class UpdateRunSnapshots(google.protobuf.message.Message):
    ...
    def snapshots(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___UpdateRunSnapshot]: ...
