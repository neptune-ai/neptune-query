...
class _IngestCodeEnumTypeWrapper(
    google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_IngestCode.ValueType], builtins.type
):
...
class UpdateRun(google.protobuf.message.Message):
    ...
    def update_snapshots(self) -> neptune_pb.ingest.v1.common_pb2.UpdateRunSnapshots:
        ...
        """
    def __init__(
        self, *, update_snapshots: neptune_pb.ingest.v1.common_pb2.UpdateRunSnapshots | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["mode", b"mode", "update_snapshots", b"update_snapshots"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["mode", b"mode", "update_snapshots", b"update_snapshots"]
    ) -> None: ...
...
class BatchProjectOperations(google.protobuf.message.Message):
    ...
    def create_runs(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[neptune_pb.ingest.v1.common_pb2.Run]:
    ...
    def __init__(
        self,
        *,
        context: global___BatchContext | None = ...,
        create_missing_project: builtins.bool = ...,
        create_runs: collections.abc.Iterable[neptune_pb.ingest.v1.common_pb2.Run] | None = ...,
        update_runs: collections.abc.Mapping[builtins.str, global___UpdateRun] | None = ...,
    ) -> None: ...
...
class CreateRunError(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal["grpc_code", b"grpc_code", "ingest_code", b"ingest_code", "message", b"message"],
    ) -> None: ...
...
class CreateRunResult(google.protobuf.message.Message):
    ...
    def error(self) -> global___CreateRunError:
        """error details."""
    def __init__(
        self, *, run: neptune_pb.ingest.v1.common_pb2.Run | None = ..., error: global___CreateRunError | None = ...
    ) -> None: ...
    def HasField(
        self, field_name: typing.Literal["error", b"error", "run", b"run", "type", b"type"]
    ) -> builtins.bool: ...
...
class ResultSummary(google.protobuf.message.Message):
    ...
    class FailedByGRPCCodeCounters(google.protobuf.message.Message):
        ...
        def __init__(
            self, *, grpc_code: google_rpc.code_pb2.Code.ValueType = ..., count: builtins.int = ...
        ) -> None: ...
    ...
    @property
    def failed_by_grpc_code(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ResultSummary.FailedByGRPCCodeCounters
    ]:
        """Failed summary details"""
    @property
    def failed_by_ingest_code(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[
        global___ResultSummary.IngestCodeCounters
    ]: ...
    def __init__(
        self,
        *,
        ...
        successful_count: builtins.int = ...,
        failed_count: builtins.int = ...,
        failed_by_grpc_code: collections.abc.Iterable[global___ResultSummary.FailedByGRPCCodeCounters] | None = ...,
        failed_by_ingest_code: collections.abc.Iterable[global___ResultSummary.IngestCodeCounters] | None = ...,
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "failed_by_grpc_code",
            b"failed_by_grpc_code",
            "failed_by_ingest_code",
            b"failed_by_ingest_code",
            "failed_count",
            b"failed_count",
            "successful_count",
            b"successful_count",
            "total_operations_count",
            b"total_operations_count",
        ],
    ) -> None: ...
...
class UpdateRunError(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "field", b"field", "grpc_code", b"grpc_code", "ingest_code", b"ingest_code", "message", b"message"
        ],
    ) -> None: ...
...
class UpdateRunResults(google.protobuf.message.Message):
    ...
    def update_errors(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___UpdateRunError]:
    ...
    def __init__(
        self,
        *,
        operations_summary: global___ResultSummary | None = ...,
        update_errors: collections.abc.Iterable[global___UpdateRunError] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["operations_summary", b"operations_summary"]) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["operations_summary", b"operations_summary", "update_errors", b"update_errors"]
    ) -> None: ...
...
class BatchResult(google.protobuf.message.Message):
    ...
    def create_run_results(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CreateRunResult]:
    ...
    def update_run_results(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___UpdateRunResults]:
        """Run update results."""
    def __init__(
        self,
        *,
        ...
        operations_summary: global___ResultSummary | None = ...,
        project: builtins.str = ...,
        create_run_results: collections.abc.Iterable[global___CreateRunResult] | None = ...,
        update_run_results: collections.abc.Mapping[builtins.str, global___UpdateRunResults] | None = ...,
        message: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["operations_summary", b"operations_summary"]) -> builtins.bool: ...
    def ClearField(
        ...
        field_name: typing.Literal[
            ...
            b"message",
            "operations_summary",
            b"operations_summary",
            "project",
            b"project",
            "update_run_results",
            b"update_run_results",
        ],
    ) -> None: ...
...
class IngestRequest(google.protobuf.message.Message):
    ...
    def batches(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BatchProjectOperations]:
...
class IngestResponse(google.protobuf.message.Message):
    ...
    def batch_results(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BatchResult]:
    ...
    def __init__(
        self,
        *,
        summary: global___ResultSummary | None = ...,
        error_message: builtins.str = ...,
        batch_results: collections.abc.Iterable[global___BatchResult] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["summary", b"summary"]) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "batch_results", b"batch_results", "error_message", b"error_message", "summary", b"summary"
        ],
    ) -> None: ...
