...
class ProtoLeaderboardEntriesSearchResultDTO(google.protobuf.message.Message):
    ...
    def entries(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ProtoAttributesDTO]: ...
    def __init__(
        self,
        *,
        matching_item_count: builtins.int = ...,
    ...
    def HasField(
        ...
        field_name: typing.Literal[
            "_total_group_count", b"_total_group_count", "total_group_count", b"total_group_count"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "_total_group_count",
            b"_total_group_count",
            "entries",
            b"entries",
            "matching_item_count",
            b"matching_item_count",
            "total_group_count",
            b"total_group_count",
        ],
    ) -> None: ...
    def WhichOneof(
        self, oneof_group: typing.Literal["_total_group_count", b"_total_group_count"]
    ) -> typing.Literal["total_group_count"] | None: ...
...
class ProtoAttributesDTO(google.protobuf.message.Message):
    ...
    def attributes(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ProtoAttributeDTO]: ...
    def __init__(
        self,
        *,
        experiment_id: builtins.str = ...,
...
class ProtoAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        file_ref_properties: global___ProtoFileRefAttributeDTO | None = ...,
        string_series_properties: global___ProtoStringSeriesAttributeDTO | None = ...,
        file_ref_series_properties: global___ProtoFileRefSeriesAttributeDTO | None = ...,
        histogram_series_properties: global___ProtoHistogramSeriesAttributeDTO | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            ...
            b"_datetime_properties",
            "_file_ref_properties",
            b"_file_ref_properties",
            "_file_ref_series_properties",
            b"_file_ref_series_properties",
            "_float_properties",
            b"_float_properties",
            "_float_series_properties",
            b"_float_series_properties",
            "_histogram_series_properties",
            b"_histogram_series_properties",
            "_int_properties",
            b"_int_properties",
            "_string_properties",
            b"_string_properties",
            "_string_series_properties",
            b"_string_series_properties",
            "_string_set_properties",
            b"_string_set_properties",
            "bool_properties",
            b"bool_properties",
            "datetime_properties",
            b"datetime_properties",
            "file_ref_properties",
            b"file_ref_properties",
            "file_ref_series_properties",
            b"file_ref_series_properties",
            "float_properties",
            b"float_properties",
            "float_series_properties",
            b"float_series_properties",
            "histogram_series_properties",
            b"histogram_series_properties",
            "int_properties",
            b"int_properties",
            "string_properties",
            b"string_properties",
            "string_series_properties",
            b"string_series_properties",
            "string_set_properties",
            b"string_set_properties",
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_bool_properties", b"_bool_properties"]
    ) -> typing.Literal["bool_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_datetime_properties", b"_datetime_properties"]
    ) -> typing.Literal["datetime_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_file_ref_properties", b"_file_ref_properties"]
    ) -> typing.Literal["file_ref_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_file_ref_series_properties", b"_file_ref_series_properties"]
    ) -> typing.Literal["file_ref_series_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_float_properties", b"_float_properties"]
    ) -> typing.Literal["float_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_float_series_properties", b"_float_series_properties"]
    ) -> typing.Literal["float_series_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_histogram_series_properties", b"_histogram_series_properties"]
    ) -> typing.Literal["histogram_series_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_int_properties", b"_int_properties"]
    ) -> typing.Literal["int_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_string_properties", b"_string_properties"]
    ) -> typing.Literal["string_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_string_series_properties", b"_string_series_properties"]
    ) -> typing.Literal["string_series_properties"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_string_set_properties", b"_string_set_properties"]
    ) -> typing.Literal["string_set_properties"] | None: ...
...
class ProtoIntAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, attribute_name: builtins.str = ..., attribute_type: builtins.str = ..., value: builtins.int = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
            "attribute_name", b"attribute_name", "attribute_type", b"attribute_type", "value", b"value"
        ],
    ) -> None: ...
...
class ProtoFloatAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, attribute_name: builtins.str = ..., attribute_type: builtins.str = ..., value: builtins.float = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class ProtoStringAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, attribute_name: builtins.str = ..., attribute_type: builtins.str = ..., value: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class ProtoBoolAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, attribute_name: builtins.str = ..., attribute_type: builtins.str = ..., value: builtins.bool = ...
    ) -> None: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class ProtoFloatSeriesAttributeDTO(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_last_step", b"_last_step"]
    ) -> typing.Literal["last_step"] | None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_variance", b"_variance"]
    ) -> typing.Literal["variance"] | None: ...
...
class ProtoFloatSeriesAttributeConfigDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, min: builtins.float | None = ..., max: builtins.float | None = ..., unit: builtins.str | None = ...
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_max", b"_max", "_min", b"_min", "_unit", b"_unit", "max", b"max", "min", b"min", "unit", b"unit"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ProtoStringSeriesAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        attribute_type: builtins.str = ...,
        last_step: builtins.float | None = ...,
        last: builtins.str | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "_last", b"_last", "_last_step", b"_last_step", "last", b"last", "last_step", b"last_step"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class ProtoFileRefSeriesAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        attribute_type: builtins.str = ...,
        last_step: builtins.float | None = ...,
        last: neptune_pb.api.v1.model.series_values_pb2.ProtoFileRef | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
...
class ProtoHistogramSeriesAttributeDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        attribute_type: builtins.str = ...,
        last_step: builtins.float | None = ...,
        last: neptune_pb.api.v1.model.series_values_pb2.ProtoHistogram | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
