...
class ProtoSeriesValuesResponseDTO(google.protobuf.message.Message):
    ...
    def series(
        ...
        global___ProtoSeriesValuesSingleSeriesResponseDTO
    ]: ...
    def __init__(
        self, *, series: collections.abc.Iterable[global___ProtoSeriesValuesSingleSeriesResponseDTO] | None = ...
    ) -> None: ...
...
class ProtoSeriesValuesSingleSeriesResponseDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        requestId: builtins.str = ...,
        searchAfter: global___ProtoSeriesValuesSearchAfterDTO | None = ...,
        string_series: global___ProtoSeriesValuesDTO | None = ...,
        seriesValues: global___ProtoSeriesValuesDTO | None = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_searchAfter", b"_searchAfter"]
    ) -> typing.Literal["searchAfter"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["series", b"series"]
    ) -> typing.Literal["string_series", "seriesValues"] | None: ...
...
class ProtoFloatSeriesValuesResponseDTO(google.protobuf.message.Message):
    ...
    def series(
        ...
        global___ProtoFloatSeriesValuesSingleSeriesResponseDTO
    ]: ...
    def __init__(
        self, *, series: collections.abc.Iterable[global___ProtoFloatSeriesValuesSingleSeriesResponseDTO] | None = ...
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["series", b"series"]) -> None: ...
...
class ProtoFloatSeriesValuesSingleSeriesResponseDTO(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, requestId: builtins.str = ..., series: global___ProtoFloatSeriesValuesDTO | None = ...
    ) -> None: ...
...
class ProtoFloatSeriesValuesDTO(google.protobuf.message.Message):
    ...
    def values(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ProtoFloatPointValueDTO]: ...
    def __init__(
        self,
        *,
        total_item_count: builtins.int = ...,
    ...
    def ClearField(
        self, field_name: typing.Literal["total_item_count", b"total_item_count", "values", b"values"]
    ) -> None: ...
...
class ProtoSeriesValuesDTO(google.protobuf.message.Message):
    ...
    def values(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ProtoPointValueDTO]: ...
...
class ProtoPointValueDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        is_preview: builtins.bool = ...,
        completion_ratio: builtins.float = ...,
        object: global___ProtoSeriesPointValueObjectDTO | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal["_object", b"_object", "_value", b"_value", "object", b"object", "value", b"value"],
    ) -> builtins.bool: ...
    def ClearField(
        self,
        field_name: typing.Literal[
...
class ProtoSeriesPointValueObjectDTO(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        stringValue: builtins.str = ...,
        histogram: global___ProtoHistogram | None = ...,
        fileRef: global___ProtoFileRef | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
            "fileRef", b"fileRef", "histogram", b"histogram", "stringValue", b"stringValue", "value", b"value"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
    ...
    ) -> typing.Literal["stringValue", "histogram", "fileRef"] | None: ...
...
class ProtoHistogram(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        type: builtins.str = ...,
        edges: collections.abc.Iterable[builtins.float] | None = ...,
        values: collections.abc.Iterable[builtins.float] | None = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["edges", b"edges", "type", b"type", "values", b"values"]
    ) -> None: ...
...
class ProtoFileRef(google.protobuf.message.Message):
    ...
    def __init__(
        self, *, path: builtins.str = ..., sizeBytes: builtins.int = ..., mimeType: builtins.str = ...
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["mimeType", b"mimeType", "path", b"path", "sizeBytes", b"sizeBytes"]
    ) -> None: ...
...
class ProtoTimeseriesBucketsDTO(google.protobuf.message.Message):
    ...
    def entries(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TimeseriesBuckets]: ...
...
class TimeseriesBuckets(google.protobuf.message.Message):
    ...
    def bucket(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TimeseriesBucket]: ...
    def __init__(
        self, *, requestId: builtins.str = ..., bucket: collections.abc.Iterable[global___TimeseriesBucket] | None = ...
    ) -> None: ...
...
class TimeseriesBucket(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        fromX: builtins.float = ...,
        toX: builtins.float = ...,
        first: global___FinitePoint | None = ...,
        last: global___FinitePoint | None = ...,
        localMin: builtins.float | None = ...,
        localMax: builtins.float | None = ...,
        finitePointCount: builtins.int = ...,
        nanCount: builtins.int = ...,
        positiveInfCount: builtins.int = ...,
        negativeInfCount: builtins.int = ...,
        localSum: builtins.float | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing.Literal[
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_localMax", b"_localMax"]
    ) -> typing.Literal["localMax"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_localMin", b"_localMin"]
    ) -> typing.Literal["localMin"] | None: ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["_localSum", b"_localSum"]
    ) -> typing.Literal["localSum"] | None: ...
