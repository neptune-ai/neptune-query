...
def _get_kwargs(
    *,
    alpha: str | Unset = UNSET,
    x_neptune_api_token: str | Unset = UNSET,
) -> dict[str, Any]:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ClientConfig | Error]:
    return Response(
