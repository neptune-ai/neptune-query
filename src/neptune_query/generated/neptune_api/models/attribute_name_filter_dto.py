...
class AttributeNameFilterDTO:
    """
    Attributes:
        must_match_any (list[AttributeNameFilterDTO] | Unset): A list of filters representing disjunctions of
        ...
        must_match_regexes (list[str] | Unset): An attribute must match all of the regexes from the list to be returned.
            Mutually exclusive with `mustMatchAny`
        must_not_match_regexes (list[str] | Unset): An attribute must match none of the regexes from the list to be
            returned. Mutually exclusive with `mustMatchAny`
    """

    must_match_any: list[AttributeNameFilterDTO] | Unset = UNSET
    must_match_regexes: list[str] | Unset = UNSET
    must_not_match_regexes: list[str] | Unset = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        must_match_any: list[dict[str, Any]] | Unset = UNSET
