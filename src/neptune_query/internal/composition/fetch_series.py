...
def fetch_series(
    *,
    ...
    output: AsyncGenerator[util.Page[tuple[identifiers.RunAttributeDefinition, list[series.SeriesValue]]]] = concurrency.flat_map_async_generator(
        ...
        downstream=lambda sys_ids: concurrency.flat_map_async_generator(
            ...
            downstream=lambda pair: concurrency.flat_map_sync(
                ...
                downstream=lambda run_attribute_definitions_split: series.fetch_series_values(
                    client=client,
    ...
    async def build_result(
        generator: AsyncGenerator[util.Page[tuple[identifiers.RunAttributeDefinition, list[series.SeriesValue]]]]
    ) -> dict[identifiers.RunAttributeDefinition, list[series.SeriesValue]]:
        results: dict[identifiers.RunAttributeDefinition, list[series.SeriesValue]] = {}
    ...
    series_data: dict[identifiers.RunAttributeDefinition, list[series.SeriesValue]] = asyncio.run(build_result(output))
