...
python -m grpc_tools.protoc \
  ...
  --mypy_out="${OUTPUT_DIR}" \
  --proto_path="./api_spec/proto/" \
  "./api_spec/proto/google_rpc/"*".proto" \
  "./api_spec/proto/neptune_pb/ingest/v1/"*".proto" \
  "./api_spec/proto/neptune_pb/ingest/v1/pub/"*".proto" \
  "./api_spec/proto/neptune_pb/api/v1/model/"*".proto"
