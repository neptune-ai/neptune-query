...
pre_process_file ./apispec/swagger/retrieval.json "retrieval"
pre_process_file ./apispec/swagger/backend.json "backend"
pre_process_file ./apispec/swagger/storagebridge_openapi.json "storage" false
pre_process_file ./apispec/swagger/ingestion_openapi.json "ingestion" false
...
cp "$tmpdir/neptune.json" ./apispec/neptune-openapi.json
...
openapi-python-client generate \
    ...
    --custom-template-path=/files/templates/ \
    --config /files/openapi-generator-config.yaml \
...
for file in client.py auth_helpers.py credentials.py; do
  cp /files/neptune_api/$file "$output_dir/neptune_api/"
done
